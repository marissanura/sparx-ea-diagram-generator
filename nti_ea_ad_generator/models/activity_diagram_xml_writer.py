...
from odoo.addons.nti_ea_diagram_generator.models.xml_writer import XMLWriter
...
class ADXMLWriter(XMLWriter):
    ...
    def init_template(self):
        ...
        tree = ElementTree.parse('/Users/marissanuramalia/Desktop/Coolyeah/Repositories/GitHub/sparx-ea-diagram-generator/nti_ea_ad_generator/models/template.xml')
