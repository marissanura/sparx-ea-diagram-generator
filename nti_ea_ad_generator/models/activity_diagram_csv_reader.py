...
from odoo.addons.nti_ea_diagram_generator.models.csv_reader import CSVReader
...
class ADCSVReader(CSVReader):
    ...
    def generate_tree(self):
        ...
        self.root = ElementTree.Element("ActivityDiagram")
    ...
    def add_element(self, name, lane, lines):
        temp = ElementTree.Element("lane" + str(lane))
